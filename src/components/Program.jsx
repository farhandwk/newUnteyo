...
const AnimatedSection = ({ children }) => (
  <motion.section
    ...
    className='w-screen h-screen mt-72 md:mt-36 flex flex-col items-center justify-center p-8 font-[helvetica] flex flex-col items-center justify-center gap-8 md:h-auto'
  >
    {children}
  </motion.section>
);
