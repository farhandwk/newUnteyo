...
const BackgroundScroll = ({ targetRef }) => {
  ...
  const opacity3 = useTransform(scrollYProgress, [0, 0.5, 0.7, 1], [0.8 , 0.6, 1, 0]);

  return (
    <div className="sticky top-0 h-0 -z-10">
      <div className="absolute top-[0vh] left-0 w-full h-screen overflow-x-hidden">
        ...
        lg:right-[-18vw] lg:w-[500px] lg:h-[500px]
        '
          style={{
            opacity: opacity3,
